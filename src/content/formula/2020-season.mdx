---
title: Hamilton equals seven in a season like no other
summary: A delayed 17-race calendar, first wins for Gasly and Perez, and Hamilton matching Schumacher's title record.
date: 2020-12-14
season: 2020
...
For months, nobody knew whether the 2020 Formula 1 season would happen at all. The pandemic delayed the opening race until July, emptied the grandstands, and turned the original calendar into a 17-race European-heavy sprint.

Once racing began, **Lewis Hamilton** and Mercedes took control. Hamilton won 11 races, equalled Michael Schumacher's seven World Championships, and passed his record for Grand Prix victories. Around them, an improvised season produced first wins for **Pierre Gasly** and **Sergio Pérez**, unfamiliar circuits, and one of Formula 1's most frightening modern accidents.

## Race Calendar

Australia was cancelled only hours before Friday practice. Vietnam never made its planned debut and Zandvoort's return was postponed, but Mugello and Portimão joined Formula 1 for the first time while the Nürburgring, Imola, and Istanbul Park returned.

The Red Bull Ring, Silverstone, and Bahrain each hosted two differently named races. The improvised calendar eventually reached **17 Grands Prix**.
...
| ALB   | 23  | Alexander Albon   | Red Bull Racing | Thailand (British-born) | 23/03/1996 | London, England | 38 | 3rd (×2) |
...
The **Bahrain Grand Prix** stopped on its opening lap after [**Romain Grosjean escaped a violent, fire-filled crash**](https://www.youtube.com/watch?v=7YMjw2sjXqU). The survival cell and halo did their job; Grosjean climbed out with burns to his hands and no major injury.

## Points, Podiums, Fastest Laps and DNFs
...
<figure class="my-8 text-center">
  ...
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-slate-400">
    Grand Prix podium finishes per driver in 2020.
  </figcaption>
</figure>
...
A shortened calendar did little to reduce Hamilton's consistency. He set the fastest lap six times, twice as often as Verstappen. Norris, Bottas, and Ricciardo recorded two each.

<figure class="my-8 text-center">
  <img
    src="/formula/2020-season/fastest_laps.svg"
    alt="Fastest laps by driver during the 2020 Formula 1 season"
    class="mx-auto"
  />
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-slate-400">
    Fastest Grand Prix laps per driver in 2020.
  </figcaption>
</figure>
...
Bottas left the opening race as championship leader, but Hamilton moved ahead after Hungary and never gave the position back. He secured the title with a wet-weather victory in Turkey, three races before the end of the season.

<figure class="my-8 text-center">
  <img src="/formula/2020-season/points_progression_drivers.svg" alt="Drivers' Championship points progression during the 2020 Formula 1 season" class="mx-auto" />
...
Mercedes led the Constructors' Championship from the first weekend and finished **254 points** ahead of Red Bull. Racing Point scored **210 points on track**, but a 15-point deduction reduced its official total to **195**. McLaren therefore finished third, seven points ahead.

<figure class="my-8 text-center">
  <img src="/formula/2020-season/points_progression_constructors.svg" alt="Constructors' Championship points progression during the 2020 Formula 1 season" class="mx-auto" />
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-slate-400">Cumulative Constructors' Championship points after each round, including Racing Point's deduction.</figcaption>
</figure>
...
| 3 | McLaren | 202 |
| 4 | Racing Point | 195 (210 − 15 deduction) |
| 5 | Renault | 181 |
| 6 | Ferrari | 131 |
| 7 | AlphaTauri | 107 |
| 8 | Alfa Romeo | 8 |
...
_Note: Results were checked against the [official Formula 1 classifications](https://www.formula1.com/en/results/2020/races). The charts were generated from the [Jolpica F1 API](https://api.jolpi.ca/ergast/f1/), the maintained successor to Ergast._
