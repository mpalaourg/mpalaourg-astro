...
<figure class="my-8 text-center">
  <img
    ...
    alt="2021 race calendar"
    class="mx-auto"
  />
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-slate-400">
    2021 Formula 1 race calendar with venues across 20 countries.
  </figcaption>
</figure>
...
<figure class="my-8 text-center">
  ...
  />
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-slate-400">
    Complete driver lineup for the 2021 Formula 1 season.
  </figcaption>
</figure>
...
<figure class="my-8 text-center">
  ...
  />
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-slate-400">
    Race winners of the 2021 Formula 1 season.
  </figcaption>
</figure>
...
<figure class="my-8 text-center">
  ...
  />
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-slate-400">
    Podium finishes per driver in the 2021 season.
  </figcaption>
</figure>
...
<figure class="my-8 text-center">
  ...
  />
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-slate-400">
    Points-scoring finishes per driver in the 2021 season.
  </figcaption>
</figure>
...
<figure class="my-8 text-center">
  ...
  />
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-slate-400">
    Fastest lap points in the 2021 Formula 1 season.
  </figcaption>
</figure>
...
<figure class="my-8 text-center">
  ...
  />
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-slate-400">
    Verstappen vs Hamilton championship battle in 2021.
  </figcaption>
</figure>
...
<figure class="my-8 text-center">
  ...
  />
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-slate-400">
    Constructors' championship points progression in 2021.
  </figcaption>
</figure>
