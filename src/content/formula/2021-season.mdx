---
title: Verstappen wins a title fight decided on the final lap
summary: Verstappen and Hamilton arrive level in Abu Dhabi before a final-lap restart decides the 2021 championship.
date: 2021-12-13
season: 2021
...
For 21 races, **Max Verstappen** and **Lewis Hamilton** traded victories, championship leads, and occasionally carbon fibre. They reached Abu Dhabi level on points. One lap later, Verstappen was World Champion.

The final restart remains inseparable from the story of 2021, but the season was bigger than its last lap: Silverstone, Monza, Brazil, Saudi Arabia, and a title fight that never settled down long enough for either driver to breathe.
...
The front-running teams changed several important pieces before the season, even though Hamilton and Verstappen stayed where they were:
...
**Max Verstappen** won 10 races and **Lewis Hamilton** eight. Behind them, the season still found room for several surprises:
...
The podium count shows how closely the title contenders matched one another.
...
Reliability and contact repeatedly changed the championship picture.
...
The progression chart shows how quickly **Max Verstappen** and **Lewis Hamilton** left everyone else behind.
...
_Note: Results were checked against the [official Formula 1 classifications](https://www.formula1.com/en/results/2021/races). The charts were generated from the [Jolpica F1 API](https://api.jolpi.ca/ergast/f1/), the maintained successor to Ergast._
