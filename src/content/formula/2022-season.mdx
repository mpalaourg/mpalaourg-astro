---
title: Verstappen makes it two as Red Bull return to the top
summary: Ferrari start quickly, Verstappen takes control, and Red Bull win their first constructors' title since 2013.
date: 2022-11-21
season: 2022
...
The new regulations initially gave Formula 1 the fight it wanted. **Charles Leclerc** won two of the opening three races, Ferrari looked quick, and Red Bull suffered early reliability problems.

It did not last. Ferrari lost points through failures, strategy calls, and driver errors, while **Max Verstappen** and Red Bull became stronger as the season went on. By Japan, Verstappen had his second World Championship; Red Bull soon followed with its first Constructors' title since 2013.
...
Verstappen won 15 races, often without starting from pole. Red Bull usually had both the race pace and the cleaner Sunday execution.
...
**Pérez** won in Monaco and Singapore, while **Russell** took his first victory in São Paulo—the only race Red Bull lost in the second half of the season.

## Points, Podiums, Sprints and DNFs

The podium count shows how quickly the balance of the season shifted.

**Verstappen** finished on the podium 17 times. **Leclerc** and **Pérez** followed with 11 each, Sainz and Hamilton had nine, and Russell added eight in his first year with Mercedes.
...
**Verstappen** scored 21 Sprint points across the three events. **Sainz** and **Leclerc** followed with 18 and 17, while Pérez and Russell also reached double figures. With points now available down to eighth, midfield drivers had far more reason to care about Saturday's result.
...
Red Bull, Ferrari, and Mercedes accounted for nearly every fastest lap.
...
<figure class="my-8 text-center">
  ...
  />
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-slate-400">
    Fastest Grand Prix laps per driver in 2022.
  </figcaption>
</figure>

Reliability had a major influence on the 2022 season.

**Sainz**, **Bottas**, **Alonso**, and **Tsunoda** each retired six times. **Albon**, **Latifi**, **Zhou**, and **Magnussen** were close behind with five.
...
At Silverstone, [**Zhou Guanyu's car flipped over the tyre barrier**](https://www.youtube.com/watch?v=T7kjjkh2lmM) on the opening lap. He escaped without serious injury.
...
_Note: Results were checked against the [official Formula 1 classifications](https://www.formula1.com/en/results/2022/races). The charts were generated from the [Jolpica F1 API](https://api.jolpi.ca/ergast/f1/), the maintained successor to Ergast._
