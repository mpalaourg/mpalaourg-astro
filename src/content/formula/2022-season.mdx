...
<figure class="my-8 text-center">
  <img
    src="https://raw.githubusercontent.com/mpalaourg/F1_DataAnalysis/main/2022-Season/imgs/calendar.png"
    alt="2022 calendar"
    class="mx-auto"
  />
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-slate-400">
    2022 Formula 1 race calendar with 22 races across 20 countries.
  </figcaption>
</figure>
...
<figure class="my-8 text-center">
  <img
    src="https://raw.githubusercontent.com/mpalaourg/F1_DataAnalysis/main/2022-Season/imgs/drivers.png"
    alt="2022 drivers"
    class="mx-auto"
  />
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-slate-400">
    Complete driver lineup for the 2022 Formula 1 season.
  </figcaption>
</figure>
...
<figure class="my-8 text-center">
  <img
    src="https://raw.githubusercontent.com/mpalaourg/F1_DataAnalysis/main/2022-Season/imgs/race_winners.png"
    alt="2022 race winners"
    class="mx-auto"
  />
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-slate-400">
    Race winners of the 2022 Formula 1 season.
  </figcaption>
</figure>
...
<figure class="my-16">
  <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
    ...
    <div class="overflow-x-auto">
      ...
      <img
        src="https://raw.githubusercontent.com/mpalaourg/F1_DataAnalysis/main/2022-Season/imgs/drivers_standings.png"
        alt="2022 driver standings"
        class="mx-auto"
      />
    </div>
    ...
    <div class="overflow-x-auto">
      ...
      <img
        src="https://raw.githubusercontent.com/mpalaourg/F1_DataAnalysis/main/2022-Season/imgs/constructor_standings.png"
        alt="2022 constructor standings"
        class="mx-auto"
      />
    </div>
