...
summary: "Uses concentrated attention and frame uniqueness to create video summaries without supervision."
tags:
  - video summarization
  - self-attention
...
- **Problem:** Common unsupervised approaches rely on unstable adversarial training or recurrent models that limit parallel training.
- **Approach:** CA-SUM uses concentrated attention and information about each frame's uniqueness and diversity to estimate importance.
- **Finding:** Tests on SumMe and TVSum showed competitive summaries with fewer learnable parameters.
