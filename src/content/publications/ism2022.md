...
summary: "Shows which video fragments influence a summary using signals from the model's attention mechanism."
tags:
  - explainable ai
  - video summarization
  - self-attention
...
featuredImage: "/publications/ism2022/featured.webp"
---

- **Problem:** A summary identifies important frames but does not show which parts of the video drove those estimates.
- **Approach:** Form an explanation mask from the summarization network's attention signals, then test it by replacing video segments.
- **Finding:** On SumMe and TVSum, explanations based on the network's own attention weights performed well at identifying influential segments.
